...
void ek_voices_change_bass_octave(uint16_t length, uint8_t *data);
void ek_voices_change_chords_octave(uint16_t length, uint8_t *data);
void ek_voices_change_lead_octave(uint16_t length, uint8_t *data);
